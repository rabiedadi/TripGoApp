...
module.exports = {
    ...
    initiate:function (req, res, next) {
        ...
        offerModel.create({_id:mongoose.Types.ObjectId("5edfdea8b920270019e9a61e"), hotel:mongoose.Types.ObjectId("5edfdea8b920270019e90000"), room:mongoose.Types.ObjectId("5edfdea8b920270019e9a606"), services:["Free WIFI", "Restaurant", "Room service"], reserved:[{dateIn:"2020-08-01", dateOut:"2020-08-05"}]})
        offerModel.create({_id:mongoose.Types.ObjectId("5edfdea8b920270019e9a61f"), hotel:mongoose.Types.ObjectId("5edfdea8b920270019e90001"), room:mongoose.Types.ObjectId("5edfdea8b920270019e9a607"), services:["Free WIFI", "Restaurant", "Room service"], reserved:[{dateIn:"2020-08-06", dateOut:"2020-08-10"}]})
        offerModel.create({_id:mongoose.Types.ObjectId("5edfdea8b920270019e9a620"), hotel:mongoose.Types.ObjectId("5edfdea8b920270019e90002"), room:mongoose.Types.ObjectId("5edfdea8b920270019e9a608"), services:["Free WIFI", "Restaurant", "Room service"], reserved:[{dateIn:"2020-08-11", dateOut:"2020-08-15"}]})
        offerModel.create({_id:mongoose.Types.ObjectId("5edfdea8b920270019e9a621"), hotel:mongoose.Types.ObjectId("5edfdea8b920270019e90003"), room:mongoose.Types.ObjectId("5edfdea8b920270019e9a609"), services:["Free WIFI", "Restaurant", "Room service"], reserved:[{dateIn:"2020-08-16", dateOut:"2020-08-20"}]})
